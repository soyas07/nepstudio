...
import Portfilio11 from "../../../public/assets/imgs/portfolio/1/portfolio-1.jpg";
import Portfilio12 from "../../../public/assets/imgs/portfolio/1/portfolio-2.jpg";
            ...
            <div className="portfolio__list-1">
              <div className="portfolio__item">
                ...
                <div className="portfolio__info">
                  <h3 className="portfolio__title">Profixer</h3>
                  <p>2024</p>
                </div>
              </div>
              <div className="portfolio__item">
                ...
                <div className="portfolio__info">
                  <h3 className="portfolio__title">HandymanX</h3>
                  <p>2024</p>
                </div>
              </div>
              <div className="portfolio__item">
